...
async def setup(bot):
    ...
    # @bot.slash_command(name="qai_old", description="Ask QAI any question... it knows all! OLD WITHOUT IMAGE GENERATION AND TOOLS")
    ...
    @bot.slash_command(name="qai", description="mAgIc! Ask QAI any question... it knows all and uses all its tools!")
    ...
    @bot.slash_command(name="makeimage", description="Generate an image based on your text prompt.")
    ...
    @bot.slash_command(name="imdb", description="Search for movies and shows on IMDb.")
    ...
    @bot.slash_command(name="virustotal", description="Query VirusTotal for URLs, domains, IPs, and hashes.")
    ...
    @bot.slash_command(name="marktplaats", description="Search for items on Marktplaats.")
    ...
    @bot.slash_command(name="torrent", description="Search for torrents on MagnetDL.")
    ...
    @bot.slash_command(name="iptorrents", description="Search for torrents on IPTorrents.")
    ...
    @bot.slash_command(name="weather", description="Get weather information for a specified location.")
